...
@csrf
  ...
  <div class="col-md-12">
    ...
    <input type="text" class="form-control" id="inputFuncao" value="{{old('genero',$registroMusicas->genero)}}" name="genero">
    @error('funcao')
  ...
  <div class="col-md-12">
    ...
    <input type="text" class="form-control" id="inputFuncao" value="{{old('valor',$registroMusicas->valor)}}" name="valor">
    @error('funcao')
  <div class="text-sm-start text-light">*Preencher o campo Função.</div>
  @enderror
  </div>
